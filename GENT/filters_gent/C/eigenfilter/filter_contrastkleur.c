...
/*   void Beeldcompressen(ImlibImage*,int*,int,int);*/
   ...
   int BerekenGemGrijswaarde(ImlibImage*,int,int*,int*,int);
...
/* Creëren van de files waarin ik de resultaten ga wegschrijven*/
   fpuniformiteit=fopen ("kleuruniformiteit","w");
   fpcontrast=fopen("kleurcontrast","w");
  /* fpinvdiffmoment=fopen("invdiffmoment","w");
   fpentropie=fopen("entropie","w");*/
   fpgebiedsgrootten=fopen("kleurgebiedsgrootten","w");
   fpgemgrijswaarden=fopen("kleurgemgrijswaarden","w");
...
void Cooc(int hor,int ver, int width,ImlibImage *compbeeld,
...
void Beeldblurren(ImlibImage *compbeeld,int *blurbeeld,int width,
...
void KleurGebiedje(ImlibImage *compbeeld, int width, int *venster,
...
int BerekenGemGrijswaarde(ImlibImage *compbeeld, int width, int *scanbijhouder,
                                            int *venster, int aantalpunten){
