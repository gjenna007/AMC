 ...
 #include <stdio.h>
 #define mask 11
 #define tolerantie 10/*De range waarin de grijswaarden
...
/* Load the image specified as the first argument */
   ...
   silhouet=Imlib_load_image(dsilhouet,"silhouetderudder03.tif");/*Met de functie
...
Imlib_save_image_to_ppm(dresultaatbeeld, resultaatbeeld, "xderuddere03.ppm");
Imlib_save_image_to_ppm(dkleurpalet, kleurpalet, "100paletxderuddere03.ppm");
Imlib_save_image_to_ppm(dechtbeeld, echtbeeld, "100xderudderefiltered03.ppm");
