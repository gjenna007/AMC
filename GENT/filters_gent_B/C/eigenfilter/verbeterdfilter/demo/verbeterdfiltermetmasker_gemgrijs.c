...
/* En nu het ingekleurde beeld wegschrijven*/
  Imlib_save_image_to_ppm (dresultaatbeeld, resultaatbeeld, "aadaptol.ppm");
  Imlib_save_image_to_ppm (dkleurpalet, kleurpalet, "badaptol.ppm");
  Imlib_save_image_to_ppm (dcompbeeld, compbeeld, "cadaptol.ppm");
