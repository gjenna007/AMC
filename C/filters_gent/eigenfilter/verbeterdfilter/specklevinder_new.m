...
%zoektop
         ...
         volgorde=1; 
         while volgorde
			    volgorde=max(max((beeld(witstepuntver-1:witstepuntver+1,witstepunthor-1:witstepunthor+1)>
             beeld(witstepuntver,witstepunthor)).*TOPVOLGORDE));
   		    witstepuntver=witstepuntver+mod(volgorde,3)-1;
             witstepunthor=witstepunthor+floor(volgorde/3)-2;
       	end
